public class Points {
    public static void main(String[] args) {
        ...
        System.out.println("Gryffindor's points are: " + points);

        System.out.println("Harry was caught wandering the halls. -50 points for Gryffindor");
        points -= 50;
        System.out.println("Gryffindor's points are now: " + points);
        ...
        System.out.println("The final point value for Gryffindor is: " + points);
        }
